  ...
  return (
    ...
    >
      {avatar ? (
        ...
        <div
          aria-hidden
          className="pointer-events-none mx-auto grid h-32 w-32 place-content-center rounded-full border-2 border-bolt/30 bg-bolt/10 font-display text-4xl font-extrabold text-bolt"
        >
          {initials}
        </div>
      )}
      ...
      <span className="text-center text-sm font-semibold text-bolt">{author}</span>
    </motion.div>
  );
}
