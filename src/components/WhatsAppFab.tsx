...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-bolt text-ink shadow-bolt transition-all duration-300 ${
