  ...
  return (
    <section id="why" className="relative scroll-mt-20 py-20 sm:py-28">
          ...
          <div>
            <Reveal>
              ...
              <p className="mt-5 max-w-md text-chalk-dim">
                ...
                and leaves the job neat, safe and compliant.
              </p>
            </Reveal>

            <Reveal delay={0.1}>
              <div className="mt-8 flex flex-wrap gap-3">
                <Badge label="Certified & Compliant" />
                <Badge label="CoC issued" />
                <Badge label="Emergency standby" />
              </div>
            </Reveal>
          </div>
          ...
          <ul className="grid gap-4 sm:grid-cols-2">
            {whyChooseUs.map((item, i) => (
              <Reveal as="li" key={item.title} delay={i * 0.08}>
                <div className="group panel h-full p-6 transition-colors duration-300 hover:border-bolt/40">
                  <span className="font-mono text-sm font-bold text-bolt/70">
                    0{i + 1}
                  </span>
      ...
      <div className="shell mt-16">
        <Reveal>
          <div className="relative overflow-hidden rounded-xl2 border border-dashed border-bolt/50 bg-bolt/[0.06] p-6 sm:p-8">
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              <div>
                <p className="font-mono text-[0.7rem] uppercase tracking-[0.22em] text-bolt">
                  {site.offer.badge}
                </p>
              ...
              <a href="#quote" className="btn-bolt shrink-0">
                Claim it
              </a>
            </div>
          </div>
