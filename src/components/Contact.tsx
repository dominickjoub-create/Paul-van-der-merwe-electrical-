            ...
            <div className="relative flex flex-col gap-3">
              {cards.map((c, i) => (
                <Reveal key={c.label} delay={i * 0.08}>
                  ...
                  >
                    ...
                    <svg
                      className="ml-auto hidden shrink-0 text-chalk-faint transition-transform group-hover:translate-x-1 group-hover:text-bolt sm:block"
              ...
              <Reveal delay={0.3}>
                <a
                  ...
                  className="btn-bolt mt-2 w-full !py-4"
                >
